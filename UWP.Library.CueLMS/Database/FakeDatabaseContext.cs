...
namespace UWP.Library.CueLMS.Database
{
    public static class FakeDatabaseContext
    {
        ...
        {
            new Course {Code = "summer1", Name = "SUMMER", Description = "stuff", CreditHours = 3, RoomLocation = "room1"},
            new Course {Code = "summer2", Name = "SUMMER CLASS", Description = "work", CreditHours = 3, RoomLocation = "room2"}
        };
        public static List<Course> FallCourses = new List<Course>()
        {
            new Course {Code = "fall1", Name = "FALL", Description = "stuff", CreditHours = 3, RoomLocation = "room1"},
            new Course {Code = "fall2", Name = "FALL CLASS", Description = "work", CreditHours = 3, RoomLocation = "room2"}
        };
    }
}

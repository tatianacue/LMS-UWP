...
namespace UWP.CueLMS.Views.ContentItemUpdates
{
    ...
    /// </summary>
    public sealed partial class UpdateAssignmentItem : Page
    {
        ...
        private void SelectNewAssignment_Click(object sender, RoutedEventArgs e)
        {
            (DataContext as ModuleManagerViewModel).UpdateAssignment();
        }
    }
}
